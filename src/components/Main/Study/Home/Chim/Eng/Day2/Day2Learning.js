...
import Day2Layout from "./Day2Layout";
...
function Day2LearningContent({ onBack }) {
  ...
  useEffect(() => {
    console.log(`Day2Learning useEffect 실행: currentStep=${currentStep}`);
...
export default function Day2Learning({ onBack }) {
  return <Day2LearningContent onBack={onBack} />;
}
