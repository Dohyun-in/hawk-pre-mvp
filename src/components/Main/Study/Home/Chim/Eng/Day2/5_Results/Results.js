...
import { useDay2 } from "../Day2Context"; // Day2 컨텍스트 사용

export default function TestResult({ onBack }) {
  const { testResults, goToStep, resetDay } = useDay2(); // Day2 컨텍스트 사용
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span>오늘 말한 어휘</span>
            <span style={{ fontWeight: "bold" }}>+92개</span>
          </div>
          ...
          >
            <span>오늘 말한 문장</span>
            <span style={{ fontWeight: "bold" }}>+7개</span>
          </div>
        </div>
        {/* 하단 박스 */}
        <img
