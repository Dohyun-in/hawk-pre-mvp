...
import videoSrc from "assets/video/40s.mp4";
...
const correctSentences = [
  "In university, some people often still kept their uniforms at home.",
  "They had very deeply fond, cherished, and nostalgic romantic feelings about their school days.",
  "They altered their uniforms over a considerable period of time and eventually grew attached to them and became quite fond of them.",
  "They became fond of their uniforms.",
  "When there was a thorough inspection, they carried extra pants in their bags for emergencies, just in case, or any unexpected situations, for unexpected situations.",
  "During the inspection, they would change into wide-legged ones.",
  "Then they'd switch back to the tight ones.",
];
...
export default function Test() {
  ...
  // Day2Context 사용
  const { goToStep, updateTestResults } = useDay2();
