...
const correctSentences = [
  "So the story is, whether or not there's a story behind the uniform.",
  "Or, if you were a class president and did a lot for the school throughout the entire academic year, consistently, as a result of your hard work and dedication, then it might be hard to throw it away.",
  "Or if you spent a lot of time hanging out with friends, you don't want to throw the uniform away, right?",
  "Well, I'm not sure.",
...
export default function Test() {
  ...
  // Day1Context 사용
  const { goToStep, updateTestResults } = useDay1();
